...
document.getElementById('newExtensionButton').addEventListener('click',openExtension);
document.getElementById('closeButtonExtension').addEventListener('click',closeExtension);
...
function closeExtension() {
  newExtension.style.display = 'none';
  redirect.style.display = 'none';
  newExtension.style.display = 'none';
}

function openExtension(){
  newExtension.style.display = 'block';
}
...
function createChart() {
  ...
  tasks.forEach(el => {
    ...
    if (endDay.endsWith("½")) {
      ...
      width = filteredArray[0].offsetLeft + filteredArray[0].offsetWidth - left -80;
      console.log(width);
    }
