...
const users = [{
  ...
  events: [],
  modules: [[{ "name": "Software Engineering", "code": "5016","year":"2022","semester":"1", "coursework": [{ "name": "Report", "type": "COURSEWORK", "weighting": "45", "start": "2022-05-01", "end": "2022-05-10" }, { "name": "Demo", "type": "PRESENTATION", "weighting": "45", "start": "2022-05-10", "end": "2022-05-24" }, { "name": "Synoptic", "type": "COURSEWORK", "weighting": "10", "start": "2022-05-20", "end": "2022-05-31" }] }, { "name": "Data Science", "code": "5010", "year":"2022","semester":"1","coursework": [{ "name": "Stats", "type": "EXAM", "weighting": "45", "start": "2022-05-02", "end": "2022-05-12" }, { "name": "Machine Learning", "type": "EXAM", "weighting": "45", "start": "2022-05-12", "end": "2022-05-26" }, { "name": "Synoptic", "type": "COURSEWORK", "weighting": "10", "start": "2022-05-20", "end": "2022-05-31" }] }, { "name": "Programming", "code": "5012","year":"2022","semester":"1", "coursework": [{ "name": "Java", "type": "EXAM", "weighting": "30", "start": "2022-05-03", "end": "2022-05-13" }, { "name": "C++", "type": "EXAM", "weighting": "60", "start": "", "end": "2022-05-29" }, { "name": "Synoptic", "type": "COURSEWORK", "weighting": "10", "start": "2022-05-20", "end": "2022-05-31" }] }]],
...
app.post('/module_creator', checkAuthenticated, async (req, res) => {
  try {
    ...
    obj.table.push({
      ...
      year: req.body.moduleYear1,
      semester: req.body.moduleSemester1,
      coursework: [
        {
    ...
    },
      {
        ...
        year: req.body.moduleYear2,
        semester: req.body.moduleSemester2,
        coursework: [
          {
      ...
      },
      {
        ...
        year: req.body.moduleYear3,
        semester: req.body.moduleSemester3,
        coursework: [
          {
...
app.get('/uploadPage', checkAuthenticated, (req, res) => {
  res.render('uploadedpage.ejs', { modules: modules });
})
